...
from flask import Flask,render_template,request     #- importing the Flask class from the flask module.
...
# to run application, use the command: python getpost.py  in this file's directory